...
export const teamLeads = [
  ...
  { value: "blessing_ndlovu", label: "Blessing Ndlovu" },
  { value: "donald_mashaba", label: "Donald Mashaba" },
  { value: "mildred_sithole", label: "Mildred Sithole" },
];
...
export const AddAgentForm = ({ onSuccess, onCancel }: AddAgentFormProps) => {
  ...
  const handleAddAgent = async () => {
    try {
      if (!newAgent.name || !newAgent.email || !newAgent.role || !newAgent.group || 
          !newAgent.shift_type || !newAgent.team_lead || !newAgent.team_lead_group) {
        toast({
          variant: "destructive",
          title: "Error",
  ...
  return (
    <div className="space-y-4 py-4">
      ...
      {/* Third row: Shift Type, Team Lead */}
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
      ...
      {/* Fourth row: Team Lead Group, Date of Birth */}
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
